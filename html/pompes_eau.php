<?php
require_once '../php/db.php'; // ربط قاعدة البيانات
?>
<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8">
  <title>Batteries - YRY</title>
...
<button id="filtrerBtn">🔍 فلترة</button>
    ...
    <!-- المنتجات سيتم تحميلها هنا بواسطة AJAX -->
    <div id="products-container" class="produits-liste" data-sous-type="19">
